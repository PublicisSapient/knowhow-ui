...
export class StackedAreaChartComponent implements OnInit {
  ...
  draw() {
    ...
    const highlight = function (event, d) {
      ...
      d3.selectAll('.myArea-' + kpiId).style('opacity', 0.1);
    ...
    keys.forEach((x) => {
      foreignObject
        ...
        .html(
          `<span class='rect' style='display:inline-block;width:10px; height:10px; margin: 0 5px 0 0; vertical-align: middle; background:${color(
            x,
          )}'></span>
